...
module.exports = {
  name: 'panelpingmessage',
  aliases: ['ticketpingmessage','tpm'],
  description: 'Configure the ping panel message with normal and embed text.',
      ...
      buttonCollector.on('collect', async (btnInt) => {
        ...
        if (btnInt.customId === 'test') {
          ...
          await btnInt.channel.send({
            content: selectedPanel.panelPingNormalMessage || 'No normal message provided',
            embeds: [testEmbed],
          });
        }
